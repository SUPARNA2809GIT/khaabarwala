...
<section id="mainBody">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12 col-sm-12"> <?php echo $this->session->flashdata('success'); ?> </div>
          ...
          <div class="row" >
            ...
            <div class="col-md-9">
              <div class="form-group">
                ...
                <?php echo form_error('res_id', '<div class="error">', '</div>'); ?> </div>
            </div>
          </div>
          ...
          <div class="row" >
            ...
            <div class="col-md-9">
              <div class="form-group" id="ciusineId">
                <input list="browsers" name="cuisine_name" name="cuisine_name" class="form-control" autocomplete="off">
                <datalist id="browsers">
                  <?php if(!empty($cuisine)){
                      foreach ($cuisine as $val) { ?>
                        <option value="<?php echo $val->cuisine_name; ?>">
                      <?php  } } ?>
                </datalist>
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="form-group">
                ...
                <?php echo form_error('menu_name', '<div class="error">', '</div>'); ?> </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-9">
              <div class="form-group">
                ...
                <?php echo form_error('menu_price', '<div class="error">', '</div>'); ?> </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-3">
              <label for="">
              <h4>Restaurant Icon</h4>
              </label>
            </div>
            <div class="col-md-9">
              <div class="row">
                <div class="col-md-2"><img src="<?php echo base_url(); ?>assets/images/vegetarian-food-symbol.png" height="34" width="34"> <br>
                  <input type="radio" name="menu_icon" value="vegetarian-food-symbol.png">
                </div>
                <div class="col-md-2"><img src="<?php echo base_url(); ?>assets/images/non-vegetarian-food-symbol.png" height="34" width="34"> <br>
