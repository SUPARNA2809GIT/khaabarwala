...
class Add extends CI_Controller {
   ...
   public function __construct() {
    ...
    {
        $data=array();
        $data['result'] = $this->db->query("SELECT * FROM tb_restaurant ORDER BY res_id DESC")->result();
    ...
    public function addRestaurant()
    {
        ...
        if($this->form_validation->run() == true )
        {
            ...
            $message = '<div class="alert alert-success">Resturant has been successfully added.</p></div>';
            $this->session->set_flashdata('success', $message);
    ...
    public function menu()
    {
        ...
        $data = array();
        $data['result']=$this->db->query("SELECT a.*,b.res_name FROM  tb_menu a 
                                          INNER JOIN tb_restaurant b ON a.res_id=b.res_id 
                                          ORDER BY menu_id DESC")->result();
    ...
    public function menuAdd()
    {
        ...
        if($this->form_validation->run() == true )
        {
            $array = array("res_id"=>$this->input->post('res_id'),
            ...
            $this->common_model->addRecord('tb_menu',$array);
